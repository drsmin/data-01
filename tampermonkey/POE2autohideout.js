...
`;
    ...
    //
    // 검증 범위
    //   POE1(/trade)  — 실제 응답과 DOM 을 짝으로 대조해
    //     data-id === result[].id === result[].item.id 확인. 브라우저에서도 동작 확인.
    //   POE2(/trade2) — 실제 결과 행 outerHTML 로 확인. 마크업이 POE1 과 같다.
    //     <div class="row" data-id="898efb…(64자리 16진수)">
